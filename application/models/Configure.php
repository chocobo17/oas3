 ...
 * 
 * 2011-11-01
 * 初始化Models結構-configure
 * 
 */

 
class Application_Model_Configure extends Zend_Db_Table_Abstract
{
	protected $_name = 'apps_configure';
	protected $_primary = 'configureId';
	
	// 預設讓model可以根據是否傳入主鍵值，自動判斷使用insert還是update。
